...
# selector
best_model_filepath = "chosenModel/checkpoint_85.53%acc_0.444loss_K3_lr8.00e-05_dc1.00e-03_dataset8/best_model_F3.h5"
...
def extract_model_details(model):
    ...
    for layer in model.layers:
        ...
        layer_details = {
            ...
            'Activation Function': config.get('activation'),
    ...
    if model.optimizer:
        ...
        optimizer_details = {
            'Optimizer Name': type(model.optimizer).__name__,
            'Learning Rate': optimizer_config.get('learning_rate'),
            # ... you can extract other details as needed
        }
