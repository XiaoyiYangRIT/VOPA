...
best_model_filepath = "chosenModel/checkpoint_0.076mse_0.223mae_0.276rmse_34.21%acc_39.145acc2_2.00e-04lr_1.00e-03dc_K5_dataset8/best_model_F5.h5"
...
def classify(nparr):
    if not (np.all(nparr <= 1) and np.all(nparr >= 0)):
        raise "Error: not well normalized"
    res = [None] * len(nparr)
