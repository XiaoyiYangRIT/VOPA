"""
This file is used to evaluate one single trained model
"""
...
best_model_filepath = "chosenModel/checkpoint_75.96acc_0.730loss_K3_lr2.00e-04_dc1.00e-03_dataset6/best_model_F3.h5"
#best_model_filepath = "chosenModel/checkpoint_75.96acc_0.730loss_K3_lr2.00e-04_dc1.00e-03_dataset6/best_model_F3.h5"
#best_model_filepath = "chosenModel/checkpoint_77.75acc_0.877loss_K3_lr2.00e-04_dc1.00e-03_dataset6/best_model_F3.h5"

#numOfApps = 7


def main():
    myEvaluator(best_model_filepath)
...
#        record[img] = False
    ...
    print("How many valid classes:", len(validClass))
